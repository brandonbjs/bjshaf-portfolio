                ...
                <div className="projectContent">
                    <div className="projectDescription">
                        ...
                        <p>
                            ...
                            host fantasy football drafts! This app enables the
                            user to create teams, populate them, view the
                            remaining players, and track drafted players. The
                            webpage shares vital draft information about each
                            player such as player position, team, bye week, ADP,
